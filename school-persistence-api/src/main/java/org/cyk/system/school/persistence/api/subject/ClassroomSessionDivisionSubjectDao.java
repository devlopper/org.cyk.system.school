...
public interface ClassroomSessionDivisionSubjectDao extends TypedDao<ClassroomSessionDivisionSubject> {
	...
	//Collection<ClassroomSessionDivisionSubject> readNotByClassroomSessionBySubject(ClassroomSession classroomSession,Subject subject);
	...
	Collection<ClassroomSessionDivisionSubject> readByClassroomSessionDivisionByRequired(ClassroomSessionDivision classroomSessionDivision, Boolean required);
}
