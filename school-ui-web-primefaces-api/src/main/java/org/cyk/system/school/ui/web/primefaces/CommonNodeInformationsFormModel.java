...
public class CommonNodeInformationsFormModel extends AbstractBean implements Serializable {
	...
	/*public static final String[] ALL_FIELDS = {FIELD_STUDENT_CLASSROOM_SESSION_DIVISION_RESULTS_REPORT_TEMPLATE,FIELD_STUDENT_CLASSROOM_SESSION_DIVISION_RESULTS_REPORT_SIGNER
			,FIELD_STUDENT_SUBJECT_AVERAGE_SCALE,FIELD_STUDENT_CLASSROOM_SESSION_DIVISION_AVERAGE_SCALE,FIELD_STUDENT_CLASSROOM_SESSION_AVERAGE_SCALE
			,FIELD_STUDENT_CLASSROOM_SESSION_AVERAGE_PROMOTION_SCALE,FIELD_ATTENDANCE_TIME_DIVISION_TYPE,FIELD_AGGREGATE_ATTENDANCE,FIELD_EVALUATION_PASS_AVERAGE
			,FIELD_CLASSROOM_SESSION_TIME_DIVISION_TYPE,FIELD_CLASSROOM_SESSION_DIVISION_ORDER_NUMBER_INTERVAL,FIELD_CURRENT_CLASSROOM_SESSION_DIVISION_INDEX};*/
