...
public class StudentClassroomSessionCreateManyPage extends AbstractCrudOnePage<StudentClassroomSession> implements Serializable {
	...
	protected void afterInitialisation() {
		...
		form.findInputByClassByFieldName(WebInputOneCombo.class, Form.STUDENT).setFiltered(Boolean.TRUE);
		form.findInputByClassByFieldName(WebInputOneCombo.class, Form.CLASSROOM_SESSION).setFiltered(Boolean.TRUE);
	}
