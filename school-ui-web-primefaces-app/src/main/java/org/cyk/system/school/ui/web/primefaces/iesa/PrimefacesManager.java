				...
				return new DetailsConfiguration.DefaultColumnAdapter(){
					...
					public Boolean isColumn(Field field) {
						...
						return isFieldNameIn(field, AbstractStudentClassroomSessionDivisionSubjectDetails.FIELD_STUDENT_IMAGE,AbstractStudentClassroomSessionDivisionSubjectDetails.FIELD_STUDENT_CODE
								...
								,AbstractStudentClassroomSessionDivisionSubjectDetails.FIELD_STUDENT_BIRTHDATE,AbstractStudentClassroomSessionDivisionSubjectDetails.FIELD_EVALUATION_AVERAGE_VALUE);
					}
				};
			}
		});
