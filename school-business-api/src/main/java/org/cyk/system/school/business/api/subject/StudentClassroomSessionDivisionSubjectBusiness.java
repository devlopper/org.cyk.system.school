...
public interface StudentClassroomSessionDivisionSubjectBusiness extends AbstractStudentResultsBusiness<ClassroomSessionDivisionSubject,StudentClassroomSessionDivisionSubject, StudentClassroomSessionDivisionSubjectEvaluation> {
	...
	StudentClassroomSessionDivisionSubject findByStudentByClassroomSessionDivisionBySubject(Student student,ClassroomSessionDivision classroomSessionDivision, Subject subject);
	Collection<StudentClassroomSessionDivisionSubject> findByClassroomSessions(Collection<ClassroomSession> classroomSessions);
}
